<template>
    <div>
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <h1 class="mb-10 text-left text-2xl font-bold">Checkout</h1>
            ...
            <div class="mx-auto max-w-8xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                ...
                <div class="rounded-lg md:w-2/3">
                    ...
                    <div class="relative">
                        ...
                        <!-- <input class="peer hidden" type="radio" name="radio" checked />
                            <span
                                class="peer-checked:border-yellow-400 absolute right-4 top-1/2 box-content block h-1 w-1 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                            <label
                                class="peer-checked:border-2 peer-checked:border-yellow-400 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                                for="radio_address">
                    ...
                    <div class="grid md:grid-cols-2 mt-5 mb-4 gap-6">
                        <div v-for="cart in getKeranjang" :key="cart.cart_id"
                            ...
                            <img class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                                src="https://assets.ayobandung.com/crop/0x0:0x0/750x500/webp/photo/2023/02/23/sikap-toleransi-Fiony-JKT48-1155254116.jpg"
                                alt="" />
                    ...
                    <div class="grid md:grid-cols-2 mt-5 mb-5 gap-6">
                        ...
                        <!-- <div class="relative">
                            <input class="peer hidden" id="radio_3" type="radio" value="cash_on_delivery"
                                v-model="paymentType" />
                            <span
                            class="peer-checked:border-yellow-400 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white">
                            </span>
                            <label
                            class="peer-checked:border-2 peer-checked:border-yellow-400 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                                for="radio_3">
                        ...
                        <div class="relative">
                            <input class="peer hidden" id="radio_4" type="radio" value="cash_on_delivery"
                                v-model="paymentType" />
                            <span
                            class="peer-checked:border-yellow-400 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white">
                            </span>
